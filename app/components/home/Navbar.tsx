...
export default function Navbar({ batalhas = [], mcs = [] }: NavbarProps) {
  ...
  return (
    <nav style={{
      ...
      padding: '18px 40px', borderBottom: '1px solid rgba(245,168,0,0.2)',
      background: 'rgba(17,17,17,0.97)', position: 'sticky', top: 0, zIndex: 50,
    }}>
      {/* LOGO */}
      <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
        ...
        <span style={{
          ...
          fontSize: '16px', lineHeight: '1.1', color: '#fff', textTransform: 'uppercase',
        }}>
      ...
      <ul style={{ display: 'flex', alignItems: 'center', gap: '4px', listStyle: 'none' }}>
        <li>
          <Link href="/ranking" style={{
            ...
            padding: '8px 14px', display: 'block', letterSpacing: '0.5px',
          }}>Ranking</Link>
        </li>

        {/* BATALHAS */}
        <li style={{ position: 'relative' }}
          onMouseEnter={() => setBatalhasOpen(true)}
          onMouseLeave={() => setBatalhasOpen(false)}
        >
          <button style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: '14px',
            textTransform: 'uppercase', color: 'rgba(255,255,255,0.6)', background: 'none',
            border: 'none', cursor: 'pointer', padding: '8px 14px', display: 'flex',
            alignItems: 'center', gap: '4px', letterSpacing: '0.5px',
          }}>
        ...
        {/* MCs */}
        <li style={{ position: 'relative' }}
          onMouseEnter={() => setMcsOpen(true)}
          onMouseLeave={() => setMcsOpen(false)}
        >
          <button style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: '14px',
            textTransform: 'uppercase', color: 'rgba(255,255,255,0.6)', background: 'none',
